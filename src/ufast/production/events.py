from ufast.common.equipment_kpi import open_starvation, record_equipment_downtime
...
class MachineDoneEvent:
    ...
    def handle(self, instance):
        for machine in self.machines:
            open_starvation(machine, self.timestamp)
...
class BreakdownEvent:
    ...
    def handle(self, instance):
        ...
        if self.is_breakdown:
            record_equipment_downtime(instance, self.machine, "breakdown", length)
        else:
            record_equipment_downtime(instance, self.machine, "pm", length)
